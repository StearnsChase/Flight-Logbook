...
## Validated Architect Handoff
- Architect handoff: `docs/...`
- Template check: valid
- One-surface check: valid

## Target Files
- `apps/api/src/...`: route insertion point
- `apps/api/tests/...`: parity test target

## Structural Preparation Completed
- added schema placeholder
- added route import

## TODOs Added
- `apps/api/src/...`
  `TODO (Codex)[slice-id]: implement ..., scope limited to ..., proof target ...`

## Proof Targets
- route TODO -> compatibility test for ...
